...
EXHAUSTED_TTL_429_SECONDS = 60 # 1 min (patched from 3600s — see skill hermes-agent)
EXHAUSTED_TTL_DEFAULT_SECONDS = 60 # 1 min (patched from 3600s — see skill hermes-agent)
